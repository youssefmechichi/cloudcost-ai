...
const invoices = [
  { id: "INV-001", provider: "GCP", month: "January", amount: "$420", status: "Processed" },
  { id: "INV-002", provider: "GCP", month: "February", amount: "$380", status: "Processed" },
  { id: "INV-003", provider: "GCP", month: "March", amount: "$610", status: "Anomaly detected" },
];
  ...
  return (
    <DashboardLayout>
      ...
      <p className="mt-2 text-gray-700">
        Review uploaded invoices and cost analysis history.
      </p>
